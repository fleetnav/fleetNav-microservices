...
@Tag(
        name = "Route",
        description = "The route controller of our application provides RESTful endpoints to manage and obtain detailed information about the routes of a vehicle."
)
@RestController
...
public class RouteController {
    ...
    @Operation(
            ...
            description = "Saves a new Route in the database."
    )
    @ApiResponses(
            {
                    @ApiResponse(
    ...
    @Operation(
            ...
            description = "updates an existing Route in the database"
    )
    @ApiResponses(
            {
                    @ApiResponse(
                            responseCode = "200",
                            description = "Route successfully update",
                            content = {
                                    @Content(
                                            schema = @Schema(implementation = RouteResponse.class),
                                            mediaType = "application/json"
    ...
    @Operation(
            ...
            description = "Deletes a Route object by specifying its id."
    )
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Retrieves a Route object by specifying its id."
    )
    @ApiResponses(
            value = {
                    @ApiResponse(
